...
const translations: Translations = {
    en: {
        ...
        "Practice with real prompts": "Practice with real prompts",
        "Login": "Login",
        ...
        "e.g., B.S. Computer Science, Stanford University": "e.g., B.S. Computer Science, Stanford University",
        "List your key skills (comma separated)": "List your key skills (comma separated)",
        ...
        "Decrease target": "Decrease target",
        "Increase target": "Increase target",
        "Save target": "Save target",
        "Cancel edit": "Cancel edit",
        "Trending up": "Trending up",
        "Trending down": "Trending down",
        DEMO_WORKSPACE_LIMIT_REACHED: "Demo mode: you can only create 1 workspace.",
        DEMO_INTERVIEW_LIMIT_REACHED: "You've already used your interview",
        DEMO_QUIZ_LIMIT_REACHED: "Demo mode: maximum 3 quizzes per workspace.",
        DEMO_REGISTRATION_DISABLED: "Demo mode: registration is currently disabled.",
        "This is a limited demo. You can review your previous interview from the history page.": "This is a limited demo. You can review your previous interview from the history page.",
        ...
        "HR interviews are tailored to your CV. Please upload or generate a CV before starting an HR interview.": "HR interviews are tailored to your CV. Please upload or generate a CV before starting an HR interview.",
        "Go to CV Studio": "Go to CV Studio",
        "Base CV on file": "Base CV on file",
        "PDF available": "PDF available",
        "No PDF preview (uploaded as DOCX)": "No PDF preview (uploaded as DOCX)",
        "View PDF": "View PDF",
        "Delete": "Delete",
        "Replace Base CV": "Replace Base CV",
        "Delete Base CV": "Delete Base CV",
    ...
    tr: {
        ...
        "Technical Interview": "Teknik Mülakat",
        ...
        "Failed to delete event": "Etkinlik silinemedi",
        ...
        "e.g., Software Engineer": "ör., Yazılım Mühendisi",
        "e.g., B.S. Computer Science, Stanford University": "ör., Bilgisayar Mühendisliği Lisans, Bilkent Üniversitesi",
        "List your key skills (comma separated)": "Anahtar yeteneklerinizi yazın (virgülle ayırın)",
        "Login failed. Please check your credentials.": "Giriş yapılamadı. Lütfen bilgilerinizi kontrol edin.",
        "Registration failed. Please try again.": "Kayıt işlemi başarısız oldu. Lütfen tekrar deneyin.",
        "Navigation": "Menü",
        "Main navigation menu": "Ana navigasyon menüsü",
        "Open menu": "Menüyü aç",
        "Toggle theme": "Temayı değiştir",
        "Switch language": "Dili değiştir",
        "Edit target": "Hedefi düzenle",
        "Decrease target": "Hedefi azalt",
        "Increase target": "Hedefi artır",
        "Save target": "Hedefi kaydet",
        "Cancel edit": "Düzenlemeyi iptal et",
        "Trending up": "Yükseliyor",
        "Trending down": "Düşüyor",
        DEMO_WORKSPACE_LIMIT_REACHED: "Demo modu: yalnızca 1 çalışma alanı oluşturabilirsiniz.",
        DEMO_INTERVIEW_LIMIT_REACHED: "Mülakat hakkınızı kullandınız",
        DEMO_QUIZ_LIMIT_REACHED: "Demo modu: çalışma alanı başına en fazla 3 test.",
        DEMO_REGISTRATION_DISABLED: "Demo modu: hesap oluşturma şu anda devre dışı.",
        "This is a limited demo. You can review your previous interview from the history page.": "Bu sınırlı bir demo. Önceki mülakatınızı geçmiş sayfasından inceleyebilirsiniz.",
        ...
        "CV Required": "CV Gerekli",
        "HR interviews are tailored to your CV. Please upload or generate a CV before starting an HR interview.": "İK mülakatları CV'nize göre özelleştirilir. İK mülakatına başlamadan önce lütfen bir CV yükleyin veya oluşturun.",
        "Go to CV Studio": "CV Stüdyosuna Git",
        "Base CV on file": "Kayıtlı temel CV",
        "PDF available": "PDF mevcut",
        "No PDF preview (uploaded as DOCX)": "PDF önizleme yok (DOCX olarak yüklendi)",
        "View PDF": "PDF'i Görüntüle",
        "Delete": "Sil",
        "Replace Base CV": "Temel CV'yi Değiştir",
        "Delete Base CV": "Temel CV'yi Sil",
        ...
        // Translation audit — added in bulk
        "AI Interviewer": "Yapay Zeka Mülakatçı",
        "AI Suggestions": "Yapay Zeka Önerileri",
        "Active Workspace": "Aktif Çalışma Alanı",
        "Add bullet point": "Madde ekle",
        "All time": "Tüm zamanlar",
        "Analyzing...": "Analiz ediliyor...",
        "At least 8 characters": "En az 8 karakter",
        "Average score by interview difficulty": "Mülakat zorluğuna göre ortalama puan",
        "Avg": "Ort",
        "Avg interview score": "Ortalama mülakat puanı",
        "Avg quiz score": "Ortalama test puanı",
        "Avg score": "Ortalama puan",
        "Back": "Geri",
        "Base CV": "Temel CV",
        "Best": "En iyi",
        "CV Studio": "CV Stüdyosu",
        "Categories / Topics": "Kategoriler / Konular",
        "Categories cannot be changed after confirmation.": "Onaydan sonra kategoriler değiştirilemez.",
        "Category Selection": "Kategori Seçimi",
        "Classic 3D Avatar (stable)": "Klasik 3D Avatar (kararlı)",
        "Click to upload": "Yüklemek için tıklayın",
        "Complete a few more interviews to see topic-level scoring.": "Konu bazlı puanlamayı görmek için birkaç mülakat daha tamamlayın.",
        "Confirm & Continue": "Onayla ve Devam Et",
        "Connected": "Bağlandı",
        "Connecting...": "Bağlanıyor...",
        "Conversation": "Konuşma",
        "Conversation will appear here...": "Konuşma burada görünecek...",
        "Detailed Feedback": "Detaylı Geri Bildirim",
        "Difficulty progression": "Zorluk ilerlemesi",
        "Disconnected": "Bağlantı kesildi",
        "Done": "Tamamlandı",
        "End Interview": "Mülakatı Bitir",
        "Evaluating Your Answers...": "Cevaplarınız Değerlendiriliyor...",
        "Evaluating...": "Değerlendiriliyor...",
        "Failed to save categories": "Kategoriler kaydedilemedi",
        "HR interview": "İK mülakatı",
        "If you leave this page, your current interview session will be permanently deleted and your progress will not be saved.": "Bu sayfadan ayrılırsanız mevcut mülakat oturumunuz kalıcı olarak silinir ve ilerlemeniz kaydedilmez.",
        "Interrupt & Speak": "Kes ve Konuş",
        "Interview Feedback": "Mülakat Geri Bildirimi",
        "Interview and quiz scores in the selected window": "Seçilen aralıktaki mülakat ve test puanları",
        "Interviewer Mode": "Mülakatçı Modu",
        "Jan 2023": "Oca 2023",
        "Last 30 days": "Son 30 gün",
        "Last 90 days": "Son 90 gün",
        "Latest": "En son",
        "Leave & Discard": "Ayrıl ve Sil",
        "Loading": "Yükleniyor",
        "Loading analytics...": "Analitik yükleniyor...",
        "Login": "Giriş",
        "Maksimum deneme sayısına ulaştınız (3).": "Maksimum deneme sayısına ulaştınız (3).",
        "Maximum 10 categories allowed": "En fazla 10 kategoriye izin verilir",
        "Mix and average score per interview mode": "Mülakat moduna göre ortalama puan ve dağılım",
        "Next steps": "Sonraki adımlar",
        "No categories found. Create a workspace with a job description first.": "Kategori bulunamadı. Önce bir iş tanımı içeren çalışma alanı oluşturun.",
        "No categories selected. Add categories below.": "Hiç kategori seçilmedi. Aşağıdan kategori ekleyin.",
        "No completed attempts yet in this window.": "Bu aralıkta henüz tamamlanmış deneme yok.",
        "No completed interviews in this window.": "Bu aralıkta tamamlanmış mülakat yok.",
        "No matching skills.": "Eşleşen yetenek yok.",
        "No skills selected yet.": "Henüz yetenek seçilmedi.",
        "Pass": "Geç",
        "Per-quiz performance and retake history": "Test bazlı performans ve tekrar geçmişi",
        "Per-topic average from your interview question scores": "Mülakat sorusu puanlarınızdan konu bazlı ortalama",
        "Photoreal LiveAvatar (beta)": "Fotogerçekçi LiveAvatar (beta)",
        "Please select a workspace from the top menu first.": "Lütfen önce üst menüden bir çalışma alanı seçin.",
        "Preparing interview...": "Mülakat hazırlanıyor...",
        "Preparing...": "Hazırlanıyor...",
        "Present": "Devam ediyor",
        "Processing your answer...": "Cevabınız işleniyor...",
        "Processing...": "İşleniyor...",
        "Product Tour": "Ürün Turu",
        "Profile Image URL": "Profil Fotoğrafı URL",
        "Question": "Soru",
        "Quiz": "Test",
        "Quiz Results": "Test Sonuçları",
        "Quiz breakdown": "Test dağılımı",
        "Record": "Kaydet",
        "Record with the microphone or type your answer here...": "Mikrofon ile kaydedin ya da cevabınızı buraya yazın...",
        "Recording": "Kaydediliyor",
        "Remove": "Kaldır",
        "Remove file": "Dosyayı kaldır",
        "Replay onboarding tour": "Karşılama turunu yeniden oynat",
        "Return to Dashboard": "Panele Dön",
        "Review your feedback below.": "Aşağıdaki geri bildirimi inceleyin.",
        "Reviewing your performance": "Performansınız inceleniyor",
        "Revisit the onboarding walkthrough to learn about all platform features": "Tüm platform özelliklerini öğrenmek için karşılama turunu tekrar izleyin",
        "Score over time": "Zaman içinde puan",
        "Search or Add Categories": "Kategori Arayın veya Ekleyin",
        "Search skills...": "Yetenek arayın...",
        "Select a workspace from the top menu to view analytics.": "Analitiği görmek için üst menüden bir çalışma alanı seçin.",
        ...
        "Submit": "Gönder",
        "Take a quiz in this workspace to see results here.": "Sonuçları burada görmek için bu çalışma alanında bir test çözün.",
        "Technical interview": "Teknik mülakat",
        "Topic": "Konu",
        "Topic breakdown": "Konu dağılımı",
        "Transcribing...": "Yazıya dökülüyor...",
        "Trend": "Eğilim",
        "Type to search or press Enter to add...": "Aramak için yazın veya eklemek için Enter'a basın...",
        "Upload Base CV": "Temel CV Yükle",
        "Upload CV (Optional)": "CV Yükle (İsteğe bağlı)",
        "Upload your main resume to use as a fallback for new workspaces": "Yeni çalışma alanları için yedek olarak kullanılmak üzere ana özgeçmişinizi yükleyin",
        "Uploaded": "Yüklendi",
        ...
        "above your average": "ortalamanızın üzerinde",
        "each dot = 1 ISO week": "her nokta = 1 ISO haftası",
        "each dot = 1 day": "her nokta = 1 gün",
