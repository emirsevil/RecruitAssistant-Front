...
const translations: Translations = {
    en: {
        ...
        DEMO_INTERVIEW_LIMIT_REACHED: "Demo mode: only 1 interview allowed per workspace.",
    ...
    tr: {
        ...
        DEMO_INTERVIEW_LIMIT_REACHED: "Demo modu: çalışma alanı başına yalnızca 1 mülakata izin verilir.",
