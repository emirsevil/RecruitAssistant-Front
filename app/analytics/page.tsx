...
import {
  LineChart, Line, AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar
} from 'recharts'
import { useLanguage } from "@/lib/language-context"

export default function AnalyticsPage() {
  const { t } = useLanguage() // Hook is used here
  const [currentSlide, setCurrentSlide] = useState(0)

  // --- MOVED DATA INSIDE THE COMPONENT ---
  ...
  const interviewPerformanceData = [
    { subject: t('Communication'), A: 85, fullMark: 100 },
    { subject: t('Problem Solving'), A: 80, fullMark: 100 },
    { subject: t('Coding'), A: 90, fullMark: 100 },
    { subject: t('System Design'), A: 70, fullMark: 100 },
    { subject: t('Behavioral'), A: 75, fullMark: 100 },
  ]
  ...
  const cvVersions = [
    { version: "v3", date: t("Dec 20, 2024"), atsScore: 85, roleMatch: 88, status: "current" },
    { version: "v2", date: t("Dec 15, 2024"), atsScore: 78, roleMatch: 82, status: "archived" },
    { version: "v1", date: t("Dec 10, 2024"), atsScore: 72, roleMatch: 75, status: "archived" },
  ]

  const upcomingTasks = [
    { task: t("Complete Behavioral Quiz"), priority: "high", dueDate: t("Today") },
    { task: t("Practice System Design Interview"), priority: "medium", dueDate: t("Tomorrow") },
    { task: t("Update CV with new project"), priority: "medium", dueDate: "Dec 25" },
    { task: t("Review weak topics"), priority: "low", dueDate: t("This week") },
  ]
      ...
      component: (
        <ResponsiveContainer width="100%" height={300}>
          <AreaChart data={skillTrendData}>
            ...
            <Tooltip />
            <Legend />
            <Area type="monotone" dataKey="Frontend" stroke="#8884d8" name={t("Frontend")} fillOpacity={1} fill="url(#colorFe)" />
            <Area type="monotone" dataKey="Backend" stroke="#82ca9d" name={t("Backend")} fillOpacity={1} fill="url(#colorBe)" />
          </AreaChart>
        </ResponsiveContainer>
      )
    }
